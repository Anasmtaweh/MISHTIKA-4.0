                ...
                <Row>
                    <Col md={4}>
                        ...
                        <div className="d-flex">
                            ...
                            <a href="https://www.reddit.com/" target="_blank" rel="noopener noreferrer" className={`text-light ${styles.footerA}`}> {/* Apply the CSS Module class */}
                                <FaReddit size={24} />
                            </a>
                        </div>
                    </Col>
                    <Col md={4}>
                        ...
                        <p>
                            <a href="https://wa.me/YOUR_PHONE_NUMBER" className={`text-light ${styles.footerA}`} target="_blank" rel="noopener noreferrer"> {/* Apply the CSS Module class */}
                                <FaWhatsapp size={20} className="me-2" /> +YOUR_PHONE_NUMBER
                            </a>
                        </p>
                        <p>
